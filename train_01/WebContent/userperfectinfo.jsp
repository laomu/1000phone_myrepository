...
<section class="content-wrapper">
	...
	%>
	<form method="post" action="${pageContext.request.contextPath }/dopage/douserperfectinfo.jsp">
		<div class="main">
			<h1 class="page-title">完善个人资料</h1>
			<div class="fieldset">
				<%
					String error = (String) request.getAttribute("ERROR_USER");
					if(error != null) {
				%>
				<h2 class="legend"><%=error %></h2>
				<%		
					} else{
				%>
	            <h2 class="legend">请对您的账号资料进行完善，方便我们给你提供更加优质的服务</h2>
	            <%} %>
				<ul class="form-list">
					<li class="fields">
						<div class="customer-name">
							<div class="input-box name-firstname">
								...
								<input type="text" readonly="readonly"  class="required-entry input-text" title="First Name" value="<%=user.getUsername() %>" name="username" id="firstname">
							</div>
							<div class="input-box">
							<label class="required" for="email_address">昵称</label>
							<input type="text" class="input-text validate-email required-entry" title="Email Address" value="<%=user.getNickName() %>" id="email_address" name="nickname">
						</div>
							<div class="clear"></div>
					...
					<li class="fields">
						<div class="customer-name">
							<div class="input-box name-firstname">
								<label for="firstname">创建时间<em>*</em></label>
								<input type="text" readonly="readonly"  class="required-entry input-text" title="First Name" value="<%=user.getRegistTime() %>" name="firstname" id="firstname">
							</div>
					...
					<li class="fields">
						<div class="customer-name">
							<div class="input-box name-firstname">
								<label for="firstname">身份证号码</label>
								<input type="text" class="required-entry input-text" title="First Name" value="<%=user.getRegNo() %>" name="regno" id="firstname">
							</div>
			...
			<li class="fields">
						<div class="customer-name">
							<div class="input-box name-firstname">
								<label for="firstname">性别<em>*</em></label>
								<input type="text" readonly="readonly"  class="required-entry input-text" title="First Name" value="<%=user.getGender() %>" name="gender" id="firstname">
							</div>
							<div class="input-box name-firstname">
								<label for="firstname">年龄<em>*</em></label>
								<input type="text" readonly="readonly" class="required-entry input-text" title="First Name" value="<%=user.getAge() %>" name="age" id="firstname">
							</div>
							<div class="clear"></div>
	...
	<li class="fields">
						<div class="customer-name">
							<div class="input-box name-firstname">
								...
								<input type="text" class="required-entry input-text" title="First Name" value="<%=user.getEmail() %>" name="email" id="firstname">
							</div>
							<div class="input-box name-firstname">
								<label for="firstname">手机</label>
								<input type="text" class="required-entry input-text" title="First Name" value="<%=user.getPhone() %>" name="phone" id="firstname">
							</div>
							<div class="clear"></div>
				...
				<div class="buttons-set">
					<p class="required">* 为不允许修改的字段</p>
					<a href="index.html" title="Back" class="f-left">&laquo; 返回主页</a>
					<input type="submit" value="完善资料" class="orange-btn"/>
					<div class="clear"></div>
				</div>
        </div>
		</div>
              ...
              <footer class="container">
                ...
                <div class="footer-bottom-block">
                  <ul class="bottom-links">
                    <li><a href="${pageContext.request.contextPath}/index.jsp" title="Home">主页</a></li>
