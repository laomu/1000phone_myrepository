...
<section class="content-wrapper">
	<div class="content-container container">
		...
		<div  class="col-main">
			<h1 class="page-title">凤凰百货商城——我要开店</h1>
			<div class="contact-form-container">
				...
				if(error!= null) {%>
					...
					%>
				<div  class="form-title">完善店铺信息</div>
					<%
				}
				...
				<ul class="form-fields">
					...
					<li class="left">
						<label>店面图片<em>*</em></label>
						<input type="file" name="file"/>
					</li>
					<li class="full-row">
						<label>店铺描述<em>*</em></label>
						<textarea name="shopdesc"></textarea>
					</li>
				</ul>
				<div class="button-set">
					<p class="required">* 为必须填写字段</p>
					<button type="submit" class="form-button"><span>开店</span></button>
				</div>
				</form>
			</div>
		</div>
