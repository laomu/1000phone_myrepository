		...
		<div class="banner wow fadeIn" data-wow-delay="0.5s">
			<div class="container">
				<div class="banner-info text-center">
					...
					<br /> <span> </span>
					<p>
						这里给您提供了可以下载各种技术的学习文档资料<br /> 在这里，你可以选择自己有兴趣的技术文档进行下载<br />
						跟着我们，一起开始学习吧....<br />
					</p>
				</div>
			</div>
			...
			<div class="doclistbox">
				<div class="doclist">
					...
					<div class="doclisttitle">
						[文档类型]&nbsp;&nbsp;<%=dt.getDeName()%><span>点击展开列表</span>
					</div>
					<ul class="info">
						<%
						...
						%>
						<li><%=doc.getDname()%><a
							href="${pageContext.request.contextPath }/deal/dealdownload.jsp?urlpath=<%=doc.getPath()%>">下载</a><span><%=doc.getPublishTime()%></span><span><%=doc.getManager().getRealName() %></span></li>
						<%
							}
								} else {
						%>
