        ...
        <script language="javascript" type="text/javascript">
            ...
            function resetTimer() {
                if (timer != null && timer != undefined) {
                    window.clearInterval(timer);
                    location.href = "${pageConext.request.contextPath}/login.jsp";
                }
            }
        </script> 
    </head>
    <body class="regist_success" onload="startTimes();">
        <h1 id="error">
	        恭喜恭喜，会员注册成功！，&nbsp;<span id="secondes">5</span>&nbsp;秒后将自动跳转，立即跳转请点击&nbsp;
            <a class="index.html" href="${pageConext.request.contextPath}/login.jsp">返回</a>
        </h1>
    </body>
</html>