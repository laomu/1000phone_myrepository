    ...
    <body>
        ...
        <div id="navi">
            <ul id="menu">
                ...
                <li><a href="${pageContext.request.contextPath}/admin/deal/dealbilllist.jsp" class="bill_on"></a></li>
        ...
        <div id="main">       
            ...
            <form enctype="multipart/form-data" action="${pageContext.request.contextPath }/admin/deal/dealbillupload.jsp" method="post" class="main_form">
                <div class="text_info clearfix"><span>软件名称：</span></div>
                <div class="input_info">
                    <input type="text" class="width300" name="toolsName" value=""/>
                    <span class="required">*</span>
                    <div class="validate_msg_short">50长度的字母、数字、汉字和下划线的组合</div>
                </div>
                <div class="text_info clearfix"><span>软件类型：</span></div>
                <div class="input_info fee_type">
                    <select style="width:206px;" name="toolsType" id="">
                       <%
                		List<ToolsType> ttList = (List<ToolsType>)request.getAttribute("ttList");
                		for(int i =0; i < ttList.size(); i++) {
                			%> 
                			<option value="<%=ttList.get(i).getTtId()%>"><%=ttList.get(i).getTtName() %></option>
                			<%
                		}
                	%>
                    </select>
                </div>
                <div class="text_info clearfix"><span>软件封面图片：</span></div>
                <div class="input_info">
                    <input type="file" value="" name="file1" class="width300" />
                    <span class="required">*</span>
                    <div class="validate_msg_short">建议100*100分辨率的图片</div>
                </div>
                <div class="text_info clearfix"><span>软件文件：</span></div>
                <div class="input_info">
                    <input type="file" value="" name="file2" class="width300" />
                    <span class="required">*</span>
                    <div class="validate_msg_short">请选择软件文件</div>
                </div>
                <div class="text_info clearfix"><span>软件描述：</span></div>
                <div class="input_info_high">
                    <textarea class="width300 height70" name="toolsDesc"></textarea>
