...
public class VerifyImgServlet extends HttpServlet {
	...
	private Font getFont() {
		...
		font[0] = new Font("Console", Font.PLAIN, 24);
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// ######################################
		// char[] ch =
		// "abcdefghigklmnopqrstuvwxyz".concat("ABCDEFGHIJKLMNOPQRSTUV").concat("WXYZ0123456789")
		// .toCharArray(); // 随即产生的字符串
		char[] ch = "abcdefghigklmnopqrstuvwxyz".toCharArray();
		// 不包括 i
		// l(小写L)
		// o（小写O）
		// 1（数字1）0(数字0)
