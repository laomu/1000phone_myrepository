	...
	<div class="content-container container">
		<div class="col-1-layout">
			<ul class="shopping-cart-table cart_table cart_table_title">
				<li class="first"><input type="checkbox" name="" id=""></li>
				<li class="second">商品图片</li>
				<li class="third">商品名称</li>
				<li class="four">商品类型</li>
				<li class="five">商品价格</li>
				<li class="six">购买数量</li>
				<li class="seven">下单时间</li>
				<li class="subtotal">小计金额</li>
			</ul>
			<%
			...
			<ul class="cart_table">
				...
				<li class="third">
					<p><%=sc.getGoods().getGname() %></p>
				</li>
				<li class="four"><%=sc.getGoods().getGoodsType().getGtName() %></li>
				<li class="five">￥<%=sc.getGoods().getPrice() %></li>
				<li class="six"><%=sc.getShoppingCount() %></li>
				<li class="seven"><%=sc.getAddTime() %></li>
				<li class="subtotal">￥<%=sc.getSubTotal() %></li>
				<div style="clear: both"></div>
			</ul>
			<%}} else { %>
			<ul class="cart_table">
				<li class="subtotal">当前购物车没有商品</li>
			</ul> 
			<%} %>
			...
			<div class="shopping-cart-collaterals">
				<div class="cart-choose-address">
					<div class="cca-title">选择收货地址</div>
					<div class="cca-addr">
						<%
					...
					<div class="cca-add-addr">
						<a href="${pageContext.request.contextPath}/dopage/dofindaddr.jsp" class="orange-btn">添加新收货地址</a>
					</div>
				</div>
			</div>
