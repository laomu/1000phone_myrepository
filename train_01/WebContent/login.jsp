		...
		<div class="main">
			...
			<div class="account-login">
				<div class="col-1 new-users">
					<div class="content">
						<h2>创建新会员</h2>
						<p>如果您还没有我们的会员账号，点击下面的创建会员按钮即可在3分钟内创建一个属于您的会员，您就可以享受我们提供的各项优质的服务，我们已经在商城里根据您的喜好准备好了礼物，亲~您还在等什么，赶紧加入我们吧！</p>
					</div>
					<div class="buttons-set">
						<a class="orange-btn" title="新会员注册" href="regist.html"><span><span>新会员注册</span></span></a>
						<div class="clear"></div>
					</div>
				</div>
				<form action="${pageContext.request.contextPath }/dopage/dologin.jsp" method="post">
				<div class="col-2 registered-users">
					<div class="content">
						...
						%>
						<p>如果您已经是我们的会员，请在这里登录</p>
						<%} %>
						<ul class="form-list">
							<li>
								<label class="required" for="email">账号<em>*</em></label>
								<div class="input-box">
									<input type="text" name="username" title="Email Address" class="input-text required-entry validate-email" value="" />
								</div>
								<div class="clear"></div>
							</li>
							<li>
								...
								<div class="input-box">
									<input type="password" name="password" title="Password" class="input-text required-entry validate-password" />
								</div>
								<div class="clear"></div>
							</li>
						</ul>
					...
					<div class="buttons-set">
						<a class="f-left" href="#">您忘记密码了吗？</a>
						<input type="submit" class="orange-btn" value="登录"/>
						<div class="clear"></div>
					</div>
            	</div>
            	</form>
