...
%>
	...
	<form method="post" action="${pageContext.request.contextPath }/dopage/dochgaddr.jsp">
		<div class="main">
			<h1 class="page-title">收货地址维护</h1>
			<div class="fieldset">
				<h2 class="legend">修改收货地址
				<%
					String error = (String) request.getAttribute("ERROR_ADDR");
					if(error != null) {out.println("&nbsp;&nbsp;&nbsp;&nbsp;<span style='color:red; font-size:12px;'>" + error + "</span>");}
				%>
				</h2>
				<ul class="form-list">
					<li class="fields">
						<div class="customer-name">
							<div class="input-box name-lastname">
								<label for="lastname">收货人<em>*</em></label>
								<input type="hidden" name="aid" value="<%=addr.getAid() %>"/>
								<input type="text" class="required-entry input-text" title="Last Name" value="<%=addr.getContact() %>" name="contact" id="lastname">
							</div>
							<div class="input-box name-lastname">
								<label for="lastname">联系方式<em>*</em></label>
								<input type="text" class="required-entry input-text" title="Last Name" value="<%=addr.getPhone() %>" name="phone" id="lastname">
							</div>
							<div class="clear"></div>
							<div class="input-box name-firstname">
								<label for="firstname">国家<em>*</em></label>
								<input type="text" class="required-entry input-text" title="First Name" value="<%=addr.getAnation() %>" name="anation"  id="firstname">
							</div>
							<div class="clear"></div>
							<div class="input-box name-lastname">
								<label for="lastname">省份<em>*</em></label>
								<input type="text" class="required-entry input-text" title="Last Name" value="<%=addr.getProvince() %>" name="province"  id="lastname">
							</div>
							<div class="input-box name-lastname">
								<label for="lastname">市区<em>*</em></label>
								<input type="text" class="required-entry input-text" title="Last Name" value="<%=addr.getCity() %>" name="city" id="lastname">
							</div>
							<div class="clear"></div>
							<div class="input-box name-lastname">
								<label for="lastname">县区<em>*</em></label>
								<input type="text" class="required-entry input-text" title="Last Name" value="<%=addr.getCountry() %>" name="country" id="lastname">
							</div>
							<div class="input-box name-lastname">
								<label for="lastname">街道<em>*</em></label>
								<input type="text" class="required-entry input-text" title="Last Name" value="<%=addr.getStreet() %>" name="street" id="lastname">
							</div>
							<div class="clear"></div>
							<div class="input-box name-lastname">
								<label for="lastname">描述<em>*</em></label>
								<textarea style="height:100px;width:520px;border:#ddd solid 1px;" name="adesc"><%=addr.getAdesc() %></textarea>
							</div>
							<div class="clear"></div>
							<div class="input-box name-lastname">
								<%
								if(addr.isStatus()) {
								%>
								<input type="checkbox" checked="checked" name="def" value="2" />
								<%} else { %>
								<input type="checkbox" name="def" value="2" />
								<%} %>设置为默认收货地址
							</div>
							<div class="clear"></div>
						</div>
				...
				<div class="buttons-set">
					...
					<input type="submit" value="修改地址" class="orange-btn"/>
					<div class="clear"></div>
				</div>
        </div>
		</div>
