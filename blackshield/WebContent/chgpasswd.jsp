		...
		<div>
             <div class="container">
                <div class="service-head">
                    <h3 style="color:#ddd;">黑盾网络信息平台会员修改登录密码</h3>
                ...
                <div class="col-md-6">
                    <div class="contact-right wow fadeInLeft" data-wow-delay="0.4s">
                        <form method="post" action="${pageContext.request.contextPath }/deal/dealchgpasswd.jsp">
                            <input type="text" class="text" name="old_passwd" placeholder="请输入旧密码..." >
                            <input type="text" class="text" name="new_pwd1" placeholder="请输入新密码...">
                            <input type="text" class="text" name="new_pwd2" placeholder="请确认密码...">
