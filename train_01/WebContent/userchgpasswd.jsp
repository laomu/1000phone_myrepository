...
<section class="content-wrapper">
	<div class="content-container container">
		<form method="post" action="${pageContext.request.contextPath }/dopage/douserchgpasswd.jsp">
		<div class="main">
			<h1 class="page-title">修改登录密码</h1>
			<div class="fieldset">
				<%
					String error =(String) request.getAttribute("ERROR_USER");
				%>
	            <h2 class="legend">请输入您的旧密码、新密码、确认新密码进行修改
	            	<%
	            	if(error != null) {out.println("<span style='color:red'>&nbsp;&nbsp;&nbsp;&nbsp;错误信息&nbsp;&nbsp;&nbsp;&nbsp;" + error + "</span>");}
	            %>
	            </h2>
				<ul class="form-list">
					<li class="fields">
						<div class="customer-name">
							<div class="input-box name-firstname">
								<label for="firstname">旧密码<em>*</em></label>
								<input type="text" class="required-entry input-text" title="First Name" value="" name="oldpassword" id="firstname">
							</div>
					...
					<li>
						...
						<div class="input-box">
							<label class="required" for="email_address">新密码<em>*</em></label>
							<input type="text" class="input-text validate-email required-entry" title="Email Address" value="" id="email_address" name="newpassword">
						</div>
						<div class="input-box">
							<label class="required" for="email_address">确认密码<em>*</em></label>
							<input type="text" class="input-text validate-email required-entry" title="Email Address" value="" id="email_address" name="confirmpassword">
						</div>
						<div class="clear"></div>
					</li>
				...
				<div class="buttons-set">
					...
					<input type="submit" value="修改" class="orange-btn"/>
					<div class="clear"></div>
				</div>
        </div>
		</div>
