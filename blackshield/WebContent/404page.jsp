...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <body class="nopage" onload="startTimes();">
        <h1 id="error">
	        SORRY!您要访问的页面不在这里，请确认您输入的URL地址是否正确！
            <br />&nbsp;<span id="secondes">5</span>&nbsp;秒后将自动跳转，立即跳转请点击&nbsp;
            <a class="index.html" href="${pageContext.request.contextPath}/login.jsp">返回</a>
        </h1>
    </body>
</html>
