...
<section class="content-wrapper">
	<div class="content-container container">
		<div class="main">
			<h1 class="page-title">收货地址维护</h1>
			<div class="fieldset">
	            <h2 class="legend">我的收货地址</h2>
				<table style="width:1000px;border:#eee solid 1px;margin-bottom:10px;">
					<tr style="height:30px;line-height:30px;text-align:center;background-color:#eee;border-bottom:#ccc solid 1px;">
						<td>国家</td>
						<td>省份</td>
						<td>市区</td>
						<td>县区</td>
					...
					<%
					List<Address> list = (List<Address>)request.getAttribute("addrList");
					if(list != null && list.size() > 0) {
						for(int i = 0; i < list.size(); i++) {
							Address addr = list.get(i);
					%>
					<tr style="height:30px;line-height:30px;text-align:center;border-bottom:#ccc dashed 1px;">
						<td><%=addr.getAnation() %></td>
						...
						<td>
							<a href="${pageContext.request.contextPath }/dopage/doprechgaddr.jsp?aid=<%=addr.getAid()%>">修改</a>
							<a href="${pageContext.request.contextPath }/dopage/dodeladdr.jsp?aid=<%=addr.getAid()%>">删除</a>
						</td>
					</tr>
					<%}} else { %>
					<tr>
						<td colspan="9">当前用户没有收货地址，请添加...</td>
					</tr>
					<%} %>
				</table>
				<h2 class="legend">添加收货地址</h2>
				<form method="post" action="${pageContext.request.contextPath }/dopage/doaddress.jsp">
				<ul class="form-list">
					<li class="fields">
						<div class="customer-name">
							<div class="input-box name-lastname">
								<label for="contact">收货人<em>*</em></label>
								<input type="text" class="required-entry input-text" title="Last Name" value="" name="contact"  id="lastname">
							</div>
							<div class="input-box name-lastname">
								<label for="phone">联系方式<em>*</em></label>
								<input type="text" class="required-entry input-text" title="Last Name" value="" name="phone" id="lastname">
							</div>
							<div class="clear"></div>
							<div class="input-box name-firstname">
								<label for="anation">国家<em>*</em></label>
								<input type="text" class="required-entry input-text" title="First Name" value="" name="anation" id="firstname">
							</div>
							<div class="clear"></div>
							<div class="input-box name-lastname">
								<label for="province">省份<em>*</em></label>
								<input type="text" class="required-entry input-text" title="Last Name" value="" name="province" id="lastname">
							</div>
							<div class="input-box name-lastname">
								<label for="city">市区<em>*</em></label>
								<input type="text" class="required-entry input-text" title="Last Name" value="" name="city" id="lastname">
							</div>
							<div class="clear"></div>
							<div class="input-box name-lastname">
								<label for="country">县区<em>*</em></label>
								<input type="text" class="required-entry input-text" title="Last Name" value="" name="country" id="lastname">
							</div>
							<div class="input-box name-lastname">
								<label for="street">街道<em>*</em></label>
								<input type="text" class="required-entry input-text" title="Last Name" value="" name="street" id="lastname">
							</div>
							<div class="clear"></div>
							<div class="input-box name-lastname">
								<label for="adesc">描述<em>*</em></label>
								<textarea style="height:100px;width:520px;border:#ddd solid 1px;" name="adesc" ></textarea>
							</div>
							<div class="clear"></div>
							<div class="input-box name-lastname">
								<input type="checkbox" name="def" value="2"/>设置为默认收货地址
							</div>
							<div class="clear"></div>
						</div>
					</li>
				...
				<div class="buttons-set">
					...
					<input type="submit" value="添加地址" class="orange-btn"/>
					<div class="clear"></div>
				</div>
				</form>
        </div>
