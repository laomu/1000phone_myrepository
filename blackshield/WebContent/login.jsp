        ...
        <!----- start-header---->
            ...
            <div class="container">
                <div class="service-head">
                    <h3 style="color:#ddd;">黑盾网络信息平台会员登录</h3>
                ...
                <div class="col-md-6">
                    <div class="contact-right wow fadeInLeft" data-wow-delay="0.4s">
                        <form method="post" action="${pageContext.request.contextPath }/deal/deallogin.jsp">
                            <input type="text" name="username" class="text" value="请输入账号..." onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = '请输入账号...';}">
                            <input type="text" name="password" class="text" value="请输入密码..." onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = '请输入密码...';}">
                            <input class="wow shake" data-wow-delay="0.3s" type="submit" value="登录系统" />
                        </form>
                    </div>
